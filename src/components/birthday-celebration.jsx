          ...
          <AnimatePresence>
            ...
            >
              <div className="text-center">
                ...
                Just wanted to remind you—"You're growing up so fast, but you'll always be my little sister. Happy birthday!
                </p>
                <p className="text-pink-600 font-medium">I hope your birthday is full of magic, and everything that makes you smile 💖</p>
                <div className="flex justify-center">
                  <motion.div
                    animate={{
                      scale: [1, 1.2, 1],
